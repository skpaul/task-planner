                ...
                <div class="main-top-nav-container">
                    <div class="container">
                        <nav id="mainTopNav" class="main-top-nav">
                            <a href="$baseUrl/index.php{$sid}"><span class="m-icons">home</span>Home</a>    
                            <!-- <a href="$baseUrl/app/applicant-copy/applicant-copy.php{$sid}"><span class="m-icons">article</span>Applicant Copy</a> -->
                            <a href="$baseUrl/app/applicant-copy/applicant-area.php{$sid}"><span class="m-icons">article</span>Applicant Area</a>
                            <!-- <a href="$baseUrl/app/status/status.php{$sid}"><span class="m-icons">article</span>Status</a> -->
                            <a href="$baseUrl/app/payment-status/payment-status.php{$sid}"><span class="m-icons">done_outline</span>Payment Status</a>
                            <a href="$baseUrl/app/recover-userid/recover-userid.php{$sid}"><span class="m-icons">perm_identity</span>Recover User ID</a>
                            <a href="https://www.photobip.com" target="_blank"><span class="m-icons">crop</span>Photo Resizer</a>
                            <a href="$baseUrl/app/help/customer-care.php{$sid}"><span class="m-icons">phone_in_talk</span>Customer Care</a>
                        </nav> 
                    </div>
                </div>
        HTML;
